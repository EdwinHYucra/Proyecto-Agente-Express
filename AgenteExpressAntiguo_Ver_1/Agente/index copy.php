...
<body>
    <div class="containerB">
        <section class="containerB-child d-block d-sm-none position-absolute vh-100">
            <div class="d-none d-sm-block logo-express">
                <img class="logo" src="../IMG/Logo-Oficial.png" alt="Logo empresa">
            </div>
            <div class="div-MenuOptions">
                <ul class="list-Option">
                    <li id="btnInicio" class="Option"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24">
                            <path fill="currentColor" d="M4 20v-9.375L2.2 12l-1.175-1.575l11-8.425L23 10.425l-.4.525q-1.125-.775-2.475-.925t-2.625.35q-1.5-.575-3.088-.262t-2.787 1.512t-1.513 2.788t.263 3.087q-.25.6-.325 1.225T10.025 20zm13.5 2.375q-1.05.725-2.312.613t-2.163-1.013t-1.012-2.162t.612-2.313q-.725-1.05-.612-2.312t1.012-2.163t2.163-1.012t2.312.612q1.05-.725 2.313-.612t2.162 1.012t1.013 2.163t-.613 2.312q.725 1.05.613 2.313t-1.013 2.162t-2.162 1.013t-2.313-.613m0-3.625q.525 0 .888-.363t.362-.887t-.363-.888t-.887-.362t-.888.363t-.362.887t.363.888t.887.362" />
                        </svg>
                        <p>Inicio</p>
                    </li>
                    <li id="listOption" class="Option listOption"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24">
                            <path fill="currentColor" d="M1 20q-.425 0-.712-.288T0 19t.288-.712T1 18h1V5q0-.825.588-1.412T4 3h16q.825 0 1.413.588T22 5v13h1q.425 0 .713.288T24 19t-.288.713T23 20zm9.5-2h3q.2 0 .35-.15t.15-.35t-.15-.35t-.35-.15h-3q-.2 0-.35.15t-.15.35t.15.35t.35.15M4 15h16V5H4zm8-5" />
                        </svg>
                        <p>Realizar Operacíon</p>
                    </li>
                    <ul id="div-options" class="OperTypeDisabled">
                        <li id="btnCashOut">Cash out</li>
                        <li id="btnCashIn">Cash in</li>
                        <li id="btnRecargas">Recargas</li>
                        <li id="btnPDigital">Productos Digitales</li>
                    </ul>
                    <li id="btnFuncOperativas" class="Option"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 16 16">
        ...
        <section class="containerB-child">
            <div class="containerB-child-info">
                <div class="div-content-info justify-center align-center">
                    <div class="div-info-cod_agent">
                        <h2 class="lead">Codigo de Agente: <?php echo htmlspecialchars($cod_agen); ?></h1>
                    </div>
                    <div class="div-info-user">
                        <h1 class=" lead welcome">Bienvenido: </h1>
                ...
                <!--<hr>-->
                <div class="div-data-system">
                    <div class="saldo"><strong>
                            <p class="h6">Este mes vas ganando: S/</p>
                        </strong>
                        <p class=" h6 saldoAc" id="Saldo"><?php echo $datacomisiones['ComisionMesActual']; ?></p>
                    </div>
                    <div class="saldo">
                        <p class="h6">Mes anterior: S/</p>
                        <p class=" h6 saldoAn" id="saldo"><?php echo $datacomisiones['ComisionMesAnterior']; ?></p>
                    </div>
                    <div class="fecha">
                        <p class="h6">Fecha: </p>
            ...
            <!--<hr>-->
            <div id="ViewInicio" class="master">
                <div class="princial">
                    <div class="div-con1">
                        <div class="div-con1-caja">
                            <h1 class="">Total Comisiones</h1>
                            <div class="div-con1-detalle">
                                <span>S/</span><span><?php echo $datacomisiones['ComisionTotal']; ?></span>
                            </div>
                        </div>                   
                    </div>
                    <div class="div-con2">
                        ...
                        <div class="div-con2-detalle">
                            <span>S/</span><?php echo ("<span>" . $membresia . "</span>") ?>
                        </div>
                ...
                <div class="detalle">
                    <div class="detalle1">
                        ...
                        <div class="detalle-precio-img">
                            <span>S/</span><span><?php echo $datacomisiones['ComisionMesActual']; ?></span>
            ...
            <div id="ViewIndicaciones" class="master1">
                <div class="contenido-Operaciones">
                    ...
                    <div class="con-op5">
                        <h1>Consultar CCI</h1>
                        <div class="Consultar-CCI">
                            <div>
                                <p>En esta seccion puede consultar el CCI de una cuenta la cual deseas realizar un
                                    deposito:</p>
                                <br>
                                <p>Si no encuentras el banco o la entidad finaciera de tu preferencias <a href="https://www.transferenciasinterbancarias.pe/obten-tu-cci/" target="_blank"> haz click aquí.</a></p>
                            </div>
                            <ul>
            ...
            <div id="ViewOperaciones" class="master2">
                <div class="caja-opera-cont">
                ...
                <div class="btns-Operaciones">
                    <button id="btnReaOper">Realizar Operación</button>
                    <button id="btnFinOper">Finalizar Operación</button>
                    <!--<button id="btnImpOper">Imprimir</button>-->
                </div>
            </div>
            <div id="ViewRecargas" class="master3">
                ...
                <div class="Caja-Op-Recargas">
                    ...
                    <div class="recordatorio-recargas">
                        <p>Recuerda que las recargas llegaran en un maximo de 5 minutos</p>
                    </div>
                    <div class="wrapper">
                        <button>
                            Recargar
            ...
            <div id="ViewIProductosDigitales" class="master4">
                <div class="caja-opera-pd">
                    ...
                    <div class="list">
                        <div class="form-element">
                            ...
                            <label for="Netflix">
                                <div class="icon">
                                    <img src="../IMG/img-icons/hombre.png" width="20px" height="20px" alt="">
                                </div>
                                <div class="title">
                                    Netflix
                                </div>
                        ...
                        <div class="form-element">
                            <input type="radio" name="platform" value="Star +" id="Star +">
                            <label for="Star +">
                                <div class="icon">
                                    <i class="fa fa-instagram"></i>
                                </div>
                        ...
                        <div class="form-element">
                            <input type="radio" name="platform" value="Free Fire" id="Free Fire">
                            <label for="Free Fire">
                                <div class="icon">
                                    <i class="fa fa-instagram"></i>
                                </div>
                        ...
                        <div class="form-element">
                            <input type="radio" name="platform" value="Fortnite" id="Fortnite">
                            <label for="Fortnite">
                                <div class="icon">
                                    <i class="fa fa-instagram"></i>
                                </div>
            ...
            <div id="ViewFuncionesOperativas" class="master5">
                <div class="apetura-caja">
                    <!-- Button trigger modal -->
                    <div class="d-flex justify-content-evenly mt-5 my-5">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ModalAperturaCaja">
                            Apertura de Caja
                        </button>
                        <button id="" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ModalDepositoRetiro">
                            Depóstiar/Retirar
                        </button>
                    </div>
                    <div>
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="ModalAperturaCaja" data-bs-backdrop="static" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="inert">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body d-flex flex-column gap-2">
                                    ...
                                    <div class="row g-3 align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <input type="text" id="txtMontoCuentaA" class="form-control" aria-describedby="passwordHelpInline">
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row g-3 align-items-center">
                                        <div class="col-auto">
                                            <label for="txtMontoEfectivoA" class="col-form-label">Saldo Caja Chica</label>
                                        </div>
                                        <div class="col-auto">
                                            <input type="text" id="txtMontoEfectivoA" class="form-control" aria-describedby="passwordHelpInline">
                                        </div>
                                        <div class="col-auto">
                                            <span id="passwordHelpInline" class="form-text">
                    ...
                    <div class="modal fade" id="ModalCierreCaja" data-bs-backdrop="static" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body d-flex flex-column gap-2">
                                    ...
                                    <div class="row g-3 align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <input type="text" id="txtMontoCuentaC" class="form-control" aria-describedby="passwordHelpInline">
                                        </div>
                                    </div>
                                    <!--Saldo Caja Chica -->
                                    <div class="row g-3 align-items-center">
                                        <div class="col-auto">
                                            <label for="txtMontoEfectivoC" class="col-form-label">Saldo Caja Chica</label>
                                        </div>
                                        <div class="col-auto">
                                            <input type="text" id="txtMontoEfectivoC" class="form-control" aria-describedby="passwordHelpInline">
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="ModalDepositoRetiro" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body d-flex flex-column gap-2">
                                    ...
                                    <div class="row g-3 align-items-center">
                                        <div class="col-auto">
                                            <label for="cmbMontoOperacionCaja" class="col-form-label">Operación</label>
                                        </div>
                                        <div class="col-auto">
                                            <select id="cmbMontoOperacionCaja" class="form-select" aria-label="Default select example">
                                    ...
                                    <div class="row g-3 align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <input type="text" id="txtMontoOperacionCaja" class="form-control" aria-describedby="passwordHelpInline">
                                        </div>
                                        <div class="col-auto">
                                            <span id="passwordHelpInline" class="form-text">
                                                * Ejemplo:"10.50","100".
                                    ...
                                    <div class="row g-3 align-items-center">
                                        <div class="col-auto">
                                            <label for="txtNroOperacionCaja" class="col-form-label">Nro Operación</label>
                                        </div>
                                        <div class="col-auto">
                                            <input type="text" id="txtNroOperacionCaja" class="form-control" aria-describedby="passwordHelpInline">
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                                    <button id="btnGuardarCajaDR" type="button" class="btn btn-success">Guardar</button>
                                    <div class="col-auto">
                ...
                <div class="container my-2">
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <table id="datatable_cajas" class="table table-striped">
                                <caption>
                                    DataTable Cajas
                                </caption>
                                <thead>
            ...
            <div id="ViewResumenOperaciones" class="master6">
                <h3>Historial de todas las operación</h3>
                <div>
                    <div class="container my-2">
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <table id="datatable_operaciones" class="table table-striped">
                                    <caption>
            ...
            <div id="ViewConfiguracion" class="master7">
                ...
                <div class="container">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <button id="btnAgregarRango" class="btn btn-outline-secondary" disabled>Agregar Rango</button>
                    </div>
                </div>
